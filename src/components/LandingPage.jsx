...
function LandingPage() {
  return (
    <div data-scroll data-scroll-speed='-.8' data-scroll-section className="w-full z-10 h-[100vh] bg-[#F1F1F1] py-11">
      <div className="flex justify-between ">
        <div className="textstructure md:text-[4.5rem]  lg:text-[6.5rem] font-['Founders_Grotesk_Medium'] lg:pl-[48px] pl-[20px] ">
          <div className="masker">
            <h1 className=" mt-24 leading-[.5vw] tracking-tight font-black text-[#212121]">
              WE CREATE
            </h1>
          </div>
          <div className="masker md:mt-2  flex items-center">
            <motion.div initial={{width:0}} animate={{width:'8rem'}} transition={{ease:[0.76, 0, 0.24, 1],duration:1,}} className="lg:w-32 w-16 md:w-[90px] md:mr-2 md:h-14 mx-1 md:mb-6 lg:mb-10 lg:h-20">
              <img  
                src="https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg"
                className="object-cover rounded-md w-full h-full  bg-center bg-cover "
                alt=""
                srcset=""
                loading="lazy"
              />
            ...
            <div>
              <h1 className="tracking-tight font-black text-[#212121]">
                EYE-OPENING
              </h1>
            </div>
          </div>
          <div className="masker">
            <h1 className="  md:mt-2  leading-[.5vw] tracking-tight font-black text-[#212121]">
              PRESANTATIONS
            </h1>
          </div>
        </div>
        <div className="lg:mt-10 md:mt-14">
      ...
      <div className="border-t-[.5px] lg:px-[50px] py-3 px-[20px] lg:mt-[145px] md:mt-60 opacity-85 flex justify-between font-['Neue_Montreal'] border-[#00000048] w-full">
        <p className="">For public and private companies</p>
        <p className="lg:pl-40 md:pr-[120px]">From the first pitch to IPO</p>
        <div className="flex items-center gap-1">
          <div>
           <button className="capitalize text-sm px-3 py-1 border-[1px] border-[#000] rounded-full font-medium">
            START THE PROJECT
           </button>
          </div>
          <div className="border-[1px] px-2 py-1 md:hidden lg:block border-[#000] rounded-full">
