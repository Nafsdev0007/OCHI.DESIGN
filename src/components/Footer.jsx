...
function Footer() {
  return (
    <div className="w-full rounded-tl-2xl rounded-tr-2xl flex justify-between md:h-[120vh] lg:h-[127vh] pt-24 lg:px-[50px] px-[20px] bg-[#F1F1F1]">
      <div className="h-[95%] w-[30%] flex justify-between flex-col">
        <h1 className='font-["Founders_Grotesk_Medium"] font-black tracking-tight leading-[6vw] text-[#212121] lg:text-8xl md:text-6xl'>
          EYE- <br />
          <span>OPENING</span>
        </h1>
        <svg
      ...
      <div className="h-[95%] w-[58%]">
        <h1 className='font-["Founders_Grotesk_Medium"] font-black tracking-tight leading-[6vw] text-[#212121] lg:text-[90px] md:text-6xl'>
          PRESENTATIONS
        </h1>

        <div className="flex justify-between font-['Neue_Montreal'] opacity-90 ">
          <div className="first-div">
            ...
            <div className="font-normal py-3 flex flex-col gap-5">
              <div>
                <ul>
                  <li>
                    <a
            ...
            <ul className=" py-5">
              <li>
                <a
                  href="emailto:nafsdev007@gmail.com"
                  className="all-a after:bg-black border-black border-b-[1px] hover:border-none mt-2"
                >
                  nafsdev007@gmail.com
                </a>
              </li>
            </ul>
          </div>
          <div className="second-div mt-36 mr-12">
        ...
        <div className="font-['Neue_Montreal'] mt-[120px] opacity-35 flex justify-between">
          <p>© ochi design 2024. <span className="border-b-[1px] border-[#9d9898]">Legal Terms</span></p>
          <ul>
            <li>
              <a
                href="#"
                className="all-a after:bg-[#9d9898] border-white border-b-[1px] hover:border-none"
              >
              Website by Obys
              </a>
            </li>
